...
(function(global,factory){
    ...
    MetaFix.viewport = function(designWidth){
        ...
        if(_os.android){
            viewport.setAttribute('content','width='+designWidth+', minimum-scale = '+ ratio +', maximum-scale = '+ ratio +', target-densitydpi=device-dpi,user-scalable=no');
            ...
            if(_os.ios && parseInt(_os.version)<7){
                viewport.setAttribute('content','width='+designWidth+',target-densitydpi=device-dpi,initial-scale='+ ratio +', user-scalable=no');
            }
        }
